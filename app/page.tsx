      ...
      <div className="space-y-5">
        <div className="flex flex-wrap items-start justify-between gap-4 rounded-[1.5rem] border border-[var(--line)] bg-[var(--surface-strong)] px-5 py-5">
          ...
          <div className="text-right">
            <p className="text-4xl">{formatClockTime(now)}</p>
        ...
        {focus ? (
          <div className="rounded-[1.6rem] border border-[var(--line)] bg-[var(--surface-strong)] px-5 py-6">
            ...
            <h2 className="mt-5 text-3xl leading-tight">{focus.title}</h2>
            ...
            <div className="mt-5 flex flex-wrap gap-3 text-sm text-[var(--muted)]">
              <Link
                href={`/day/${date}`}
                className="rounded-full border border-[var(--line)] bg-white/80 px-4 py-2 hover:border-[var(--accent)]"
              >
                Open full day view
              </Link>
              <Link
          ...
          <div className="rounded-[1.6rem] border border-dashed border-[var(--line)] bg-[var(--surface-strong)] px-5 py-6">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <span className="rounded-full bg-stone-200 px-3 py-2 text-xs uppercase tracking-[0.2em] text-stone-700">
                Clear Day
              </span>
              <CheckInBadge date={date} />
            </div>
            <h2 className="mt-5 text-3xl leading-tight">Nothing urgent is scheduled right now.</h2>
            ...
            <div className="mt-5">
              <Link
                href="/new"
                className="rounded-full border border-[var(--line)] bg-white/80 px-4 py-2 text-sm hover:border-[var(--accent)]"
              >
                Add the next item
              </Link>
            </div>
