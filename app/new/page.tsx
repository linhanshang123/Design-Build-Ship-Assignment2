...
import { addDays, getToday } from "@/lib/planner-utils";
        ...
        >
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full rounded-[1.25rem] border border-[var(--line)] bg-[var(--surface-strong)] px-4 py-3 outline-none transition focus:border-[var(--accent)]"
            />
          </div>
          ...
          <button
            type="submit"
            className="rounded-full bg-[var(--accent)] px-5 py-3 text-sm text-white transition hover:opacity-92"
          >
